...
> **\u2139\ufe0f This is the reference doc for the private-Foundry infrastructure Bicep**
> (`main.bicep` + `add-project.bicep` in this folder). For the full
> Teams-publishing solution that *uses* this infrastructure, start at the
> [top-level README](README.md) and the [`publish-agent/`](publish-agent/DESIGN_v2_shared-router-and-preauth.md)
> folder.
